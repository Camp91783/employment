...
# Rails.application.config.sorcery.submodules = [:http_basic_auth, :external, :remember_me, :reset_password, :activity_logging, :brute_force_protection, :user_activation, :session_timeout]
