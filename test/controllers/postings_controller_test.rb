...
class PostingsControllerTest < ActionController::TestCase
  ...
  test "should create posting" do
    assert_difference('Posting.count') do
      post :create, posting: { contact: @posting.contact, date_applied: @posting.date_applied, location: @posting.location, notes: @posting.notes, title: @posting.title, url: @posting.url }
    end
  ...
  test "should update posting" do
    patch :update, id: @posting, posting: { contact: @posting.contact, date_applied: @posting.date_applied, location: @posting.location, notes: @posting.notes, title: @posting.title, url: @posting.url }
    assert_redirected_to posting_path(assigns(:posting))
  end
